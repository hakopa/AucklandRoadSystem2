...
public class Mapper extends GUI {
	...
	public static final Color HIGHLIGHT_COLOUR = new Color(255, 219, 177);
	public static final Color HIGHLIGHTNODE_COLOUR = new Color(255,0,0);
	public static final Color HIGHLIGHTTONODE_COLOUR = new Color(0,153, 0);
	public static final Color HIGHLIGHTFROMNODE_COLOUR = new Color(255,128, 0);
	...
	//route highlighting
	private boolean findRoute = false;
